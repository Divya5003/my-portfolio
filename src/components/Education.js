        ...
        <div className='my-64'>
            ...
            <div ref={ref} className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
                ...
                <ul className='w-full flex flex-col items-start justify-between ml-4 xs:ml-2'>
                    ...
                    />
                    <Details
                        type="Junior College - HSC"
                        time="2019-2021"
                        place="Nutan Vidya Mandir and Jr. College, Nashik"
                        info="Specialization in Science; Physics, Chemistry and Mathematics. Scored 88.00% in HSC board exams."
                    />
                    <Details
                        type="High School - SSC"
                        time="2009-2019"
                        place="St. Xavier's High School, Nashik"
                        info="Completed my primary schooling for 10 years. Scored 91.60% in SSC board exams."
                    />
                </ul>
            </div>
        </div>
