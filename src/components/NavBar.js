...
import { GFGIcon, GithubIcon, LeetcodeIcon, LinkedInIcon, MoonIcon, SunIcon } from '@/components/Icons'
        ...
        >
            ...
            <div className='w-full flex justify-between items-center lg:hidden'>
                ...
                <nav className='flex items-center justify-center flex-wrap'>
                    <motion.a
                        href="https://github.com/Divya5003" target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className='w-6 mr-3'
                    >
                    ...
                    <motion.a
                        href="https://www.linkedin.com/in/divya-mahajan-55a766229" target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className='w-6 mx-3'
                    >
            ...
            {isOpen ?
                <motion.div
                    ...
                    className='min-w-[70vw] flex flex-col justify-between z-30 items-center fixed top-1/2 left-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32 -translate-x-1/2 -translate-y-1/2'
                >
                    ...
                    <nav className='flex items-center justify-center flex-wrap mt-2'>
                        ...
                        <motion.a
                            ...
                            whileHover={{ y: -2 }}
                            whileTap={{ scale: 0.9 }}
                            className='w-6 mx-3 sm:mx-1 p-1 bg-light rounded-full'
                        >
                            <GFGIcon />
                        </motion.a>
                        <motion.a
